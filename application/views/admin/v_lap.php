...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url(); ?>assets/custom/st_lap.css">
  <style>
      #dept-widget:hover{
        cursor: pointer;
      }
        ...
        <?php foreach($dept as $row): ?>
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              ...
              <div id="dept-widget" class="info-box-content" onclick="return lapDept(<?= $row->id_dept; ?>);">
                <span class="info-box-text area-info"><?= $row->kat_dept ?></span>
