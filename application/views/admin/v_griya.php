                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr class="text-center">
                      ...
                      <td><?= $row->nama ?></td>
                      <td><?= $row->alamat ?></td>
                      <td><?php echo number_format($row->biaya_mtc,2,",",".") ?></td>
                      <td class="text-center">
                        <a id="update_griya" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="modal" data-target="#update-griya" data-id="<?= $row->id; ?>" data-nama="<?= $row->nama; ?>" data-alamat="<?= $row->alamat; ?>"><i class="fa fa-pen-square text-light"></i>  Edit</a>
      ...
      <form action="<?= base_url(); ?>admin/update_griya" method="post">
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" name="nama" id="nama_griya" class="form-control" required autofocus>
          </div>
          <div class="form-group">
            <label for="username">Alamat</label>
