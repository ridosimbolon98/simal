                  ...
                  <tbody>
                    ...
                    <tr class="text-center">
                      ...
                      <td class="text-center">
                        <a id="update_customer" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="modal" data-target="#update-customer" data-cid="<?= $row->cid; ?>" data-nama="<?= $row->nama; ?>" data-griya_id="<?= $row->id; ?>" data-alamat="<?= $row->alamat; ?>" data-golongan="<?= $row->golongan; ?>" data-stand_meter="<?= $row->stand_meter; ?>"><i class="fa fa-pen-square text-light"></i> Edit</a>
                        <a class="btn btn-sm btn-danger" href="<?= base_url(); ?>admin/delete_customer/<?= $row->cid; ?>" onclick="return confirm('Apakah anda yakin hapus user ini?');"><i class="fa fa-trash text-light"></i> Hapus</a>
                      </td>
                    </tr>
                    <?php endforeach; ?>
                </table>
      ...
      <form action="<?= base_url(); ?>admin/add_customer" method="post">
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" name="nama" class="form-control" placeholder="Input nama customer" required autofocus>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input name="golongan" class="form-control" placeholder="Input Golongan Customer.." required>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="nama">Stand Meter</label>
            <input type="text" name="stand_meter" class="form-control" placeholder="Input stand meter">
          </div>
        </div>
      ...
      <form action="<?= base_url(); ?>admin/update_customer" method="post">
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" name="nama" id="nama_customer" class="form-control"  required autofocus>
          </div>
          <div class="form-group">
            <label for="alamat">Alamat</label>
          ...
          <div class="form-group">
            <label for="alamat">Golongan</label>
            <input name="golongan" id="golongan_customer" class="form-control" required>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="nama">Stand Meter</label>
            <input type="text" name="stand_meter" id="stand_meter" class="form-control">
          </div>
        </div>
        <div class="modal-footer">
          <button type="submit" class="btn btn-primary" id=""><i class="fa fa-save text-light" onclick="return confirm('Apakah anda yakin edit data griya ini?')"></i> Simpan</button>
          <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fa fa-times-circle text-light"></i> Batal</button>
        </div>
      </form>
    </div>
...
$(document).on("click", "#update_customer", function () {
  $(".s_griya").remove();
	...
	var stand_meter = $(this).data("stand_meter");
