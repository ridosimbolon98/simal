  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="mb-3">
          <button class="btn btn-info" data-toggle="modal" data-target="#add-user"><i class="fa fa-plus"></i> Tambah user baru</button>
        </div>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?= $row->username ?></td>
                      <td><?= $row->level ?></td>
                      <td><?= $row->area_dept ?> -- <?= $row->bagian_dept ?></td>
        ...
        <form action="<?= base_url(); ?>admin/addUser" method="post">
          <div class="modal-body">
            <div class="form-group">
              ...
              <input type="text" name="username" class="form-control" placehlder="Input username" required autofocus>
            </div>
            <div class="form-group">
              <label for="password">Password</label>
              <input id="password" type="password" name="password" class="form-control" placehlder="Input password" required>
            </div>
            <div class="form-group">
              <label for="konf_pass">Konfirmasi Password</label>
              <input id="konfPassword" type="password" name="konf_pass" class="form-control" placehlder="Input konfirmasi password" required>
