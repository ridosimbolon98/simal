        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="<?= base_url(); ?>home/np">NON-PABRIK</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= base_url(); ?>home">PABRIK</a>
                    </li>
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url(); ?>home/send" method="post" enctype="multipart/form-data">
                            <div class="mb-3">
                                ...
                                <input name="k_lok" type="hidden" class="form-control" value="NON-PABRIK">
