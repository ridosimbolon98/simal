    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?= base_url(); ?>auditor/otorisasi" class="nav-link active">
          ...
          <div class="col-sm-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Table Audit 5R Periode <?= $periode; ?> per Hari ini</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <?php $no=1; foreach($audit as $row): ?>
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="<?= base_url(); ?>auditor/del_audit/<?= $row->id_audit ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah anda yakin hapus temuan audit ini?')"> Hapus</a>
                      </td>
                    </tr>
                  <?php endforeach; ?>
