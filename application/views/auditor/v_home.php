  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Area Temuan Audit 5R</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url('auditor'); ?>">Home</a></li>
              <li class="breadcrumb-item active">Area Audit</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-sm-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Area Auditie yang Sudah di Audit</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="row">
